...
fn decimal128_bindings() {
    ...
    <D as ArrowBinding>::append_value(&mut b, &typed_arrow::Decimal128::<38, 4>(12_345)); // 1.2345
    <D as ArrowBinding>::append_null(&mut b);
    <D as ArrowBinding>::append_value(&mut b, &typed_arrow::Decimal128::<38, 4>(-9)); // -0.0009
...
fn decimal256_bindings() {
    ...
    <D as ArrowBinding>::append_value(
        &mut b,
        &typed_arrow::Decimal256::<76, 10>(i256::from(12345i64)),
    );
    <D as ArrowBinding>::append_value(
        &mut b,
        &typed_arrow::Decimal256::<76, 10>(i256::from(-7i64)),
    );
