...
fn main() {
    ...
    let mut id_builder: <Person as ColAt<0>>::ColumnBuilder =
        typed_arrow::arrow_array::builder::PrimitiveBuilder::<typed_arrow::arrow_array::types::Int64Type>::with_capacity(3);
    ...
    let mut nb: <Person as ColAt<1>>::ColumnBuilder =
        typed_arrow::arrow_array::builder::StringBuilder::with_capacity(3, 0);
    ...
    let mut sb: <Person as ColAt<2>>::ColumnBuilder =
        typed_arrow::arrow_array::builder::PrimitiveBuilder::<typed_arrow::arrow_array::types::Float32Type>::with_capacity(3);
    ...
    // Inspect values
    let id = cast::as_primitive_array::<typed_arrow::arrow_array::types::Int64Type>(&id_array);
    let name = typed_arrow::arrow_array::cast::as_string_array(&na);
    let score = cast::as_primitive_array::<typed_arrow::arrow_array::types::Float32Type>(&sa);
    println!(
