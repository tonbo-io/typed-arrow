...
use typed_arrow_dyn::arrow_array::{Array, cast};
use typed_arrow_dyn::arrow_schema::{DataType, Field, Schema};
use typed_arrow_dyn::DynBuilders;
...
fn append_none_row_sets_all_nulls() {
    ...
    let a = cast::as_primitive_array::<typed_arrow_dyn::arrow_array::types::Int64Type>(batch.column(0));
